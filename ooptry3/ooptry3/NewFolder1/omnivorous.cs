...
namespace ooptry3
{
    class omnivorous: organisms<foodomni>
    {
       

        public override void makepair(entity el2, Random rand)
        {
            this.pair = ((omnivorous)el2).pair = true;
            this.tochka.x = ((omnivorous)el2).tochka.x = (this.x + el2.x) / 2;
            this.tochka.y = ((omnivorous)el2).tochka.y = (this.y + el2.y) / 2;
            this.index = ((omnivorous)el2).index = rand.Next(1000);
        }
